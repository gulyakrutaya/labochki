...
class Ackanoid:
    # unb - number of unbreakable bricks, bon - bonus
    def __init__(self, w=1200, h=800, unb=0, bon=0):
        self.w = w
        self.h = h
        self.unb = unb
        self.bon = bon
    ...
    def __sound(self):
        self.collision_sound = pygame.mixer.Sound('C:\\Users\\gulbe\\OneDrive\\Рабочий стол\\PP2\\lab8\\catch.mp3')
